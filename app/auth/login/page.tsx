      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-b from-[#064E3B] to-[#0D6948] text-white p-12 flex-col justify-between">
        ...
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-base text-gray-100 font-medium">Streak Tracking</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-[#10B981] flex items-center justify-center flex-shrink-0">
              <Check size={18} className="text-white" strokeWidth={3} />
            </div>
            <span className="text-base text-gray-100 font-medium">Multipliers</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-[#10B981] flex items-center justify-center flex-shrink-0">
              <Check size={18} className="text-white" strokeWidth={3} />
            </div>
            <span className="text-base text-gray-100 font-medium">Secure Wallet</span>
          </div>
        </div>
      </div>
